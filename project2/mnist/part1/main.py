...
#
# print("train_x:", train_x) # each row of train_x contains the features of one image, which are simply the raw pixel values flattened out into a vector of length 28^2
# print("train_y:", train_y) # label of each number
# print("test_x:", test_x) # matrix like train_x of testing samples
# print("test_y:", test_y) # labels for test_x
#
...
#
# # softmax mod 3 test_error= 0.1872 (using compute_test_error_mod3 over train_y_mod3 and test_y_mod3
# # softmax mod 3 test_error= 0.7001 (using compute_test_error_mod3 over train_y and test_y
#
# # softmax mod 3 test_error= 0.18720000000000003 (using compute_test_error over train_y_mod3 and test_y_mod3
# # softmax mod 3 test_error= 0.6978 (using compute_test_error over train_y and test_y
#
# # softmax mod 3 test_error= 0.0768 (using compute_test_error over train_y and test_y_mod3
#
...
# print('softmax using PCA with 18 components test_error =', test_error)
...
# train_pca_10 = train_pca[:,:10]
# test_pca_10 = test_pca[:,:10]
# print("train_pca_10[0, ]: ", train_pca[0, ])
#
# train_pca10 = project_onto_PC(train_x, pcs, 10, feature_means)
# test_pca10 = project_onto_PC(test_x, pcs, 10, feature_means)
# print("train_pca10[0, ]: ", train_pca[0, ])
#
# theta, cost_function_history = softmax_regression(train_pca_10, train_y, temp_parameter=1, alpha= 0.3, lambda_factor = 1.0e-4, k = 10, num_iterations = 150)
# plot_cost_function_over_time(cost_function_history)
# test_error = compute_test_error(test_pca_10, test_y, theta, temp_parameter=1)
# print('softmax using 10-d dimensions PCA with 18 components test_error =', test_error)
#
...
# print('softmax using 10-d dimensions PCA with 18 components and cubic features test_error =', test_error)


#####################
# based from: https://github.com/dnackat/mitx-6.86x-machine-learning/blob/master/project2/mnist/part1/main.py
